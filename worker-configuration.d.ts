/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 40707af02a448c7e452f28c5fbfd790e)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		APP_PUBLIC_ENDPOINT: string;
		APP_PUBLIC_API_ENDPOINT: string;
		DB_URL: string;
		SESSION_SECRET: string;
		MAIL_WORKER_CRYPTO_SECRET: string;
		ATSUBMIT_MAIL: Fetcher /* atsubmit-mail */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_SESSION_NAME" | "APP_SESSION_DOMAIN" | "APP_PUBLIC_ENDPOINT" | "APP_PUBLIC_API_ENDPOINT" | "DB_URL" | "SESSION_SECRET" | "MAIL_WORKER_CRYPTO_SECRET">> {}
}
